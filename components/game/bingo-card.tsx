...
export function BingoCard({ card, onRemove, calledNumbers = [], highlightWin, winningCells }: BingoCardProps) {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-2">
        <span className="text-xs text-gray-500 font-medium">Card #{card.card_number}</span>
        {onRemove && (
